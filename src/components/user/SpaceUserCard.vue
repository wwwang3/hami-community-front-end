        ...
        <div class="user-card-container">
            ...
            <div class="user-card-body">
                <div class="profile-item">
                    <span class="ellipsis username">{{ user.username }}</span>
                    <el-tag v-if="user.tag" class="tag">{{ user.tag }}</el-tag>
                </div>
                <div class="work">
                    <div class="profile-item company" v-if="user.company || user.position">
                        ...
                        <span class="ellipsis content">{{ user.company }}</span>
                    </div>
                    <div class="divider">|</div>
                    <div class="profile-item position">
                        <span class="ellipsis content">{{ user.position }}</span>
                    </div>
                </div>
                ...
                <div class="bottom">
                    <div class="profile-item blog">
                        <el-icon class="icon" size="20" v-if="user.blog">
